...
### User Story 5
Como jogador, quero alterar o idioma do jogo para espanhol para utilizar a interface noutra língua.

#### Passos testados
1. Aceder ao website do Battleship
2. Aceitar cookies
3. Abrir definições
4. Selecionar o idioma espanhol
5. Verificar que a interface mudou para espanhol

---

### User Story 6
Como jogador, quero selecionar a opção de míssil num jogo contra um robô.

#### Passos testados
1. Aceder ao website do Battleship
2. Aceitar cookies
3. Carregar em “Play vs robot”
4. Inserir o nickname "Teste"
5. Carregar em “Continue”
6. Entrar numa partida contra o robô
7. Selecionar o botão de missil
8. Verificar que a opção de míssil foi selecionada

---

### User Story 7
Como jogador, quero enviar uma mensagem numa sala privada para comunicar com outro jogador.
...
5. Carregar em “Continue”
6. Entrar na sala privada
7. Escrever a mensagem "Olá amigo"
8. Carregar no botão de envio da mensagem

---

### User Story 8
Como jogador, quero visualizar um avatar na loja para consultar os monstros disponíveis.
